                ...
                <div className="grid grid-cols-1  md:grid-cols-3 md:mt-5 md:gap-5">
                    <div className="flex flex-col col-span-2">
                        ...
                        <div className="flex flex-col gap-5">
                            {[...Array(5)].map((_, i) => (
                                <>
                                    <div className="bg-gray-100 rounded-md p-4 w-full mb-4" key={i}>
                                        <div className="flex flex-col lg:flex-row gap-10">
                                            <div className="hidden lg:block flex-shrink-0">
                                                <img
                                                    src="/public/images/coffe.png"
                                                    alt="Coffee"
                                            ...
                                            <div className="flex flex-col gap-3 w-full">
                                                <div className="grid grid-cols-2 lg:grid-cols-4  gap-4">
                                                    <div className="flex flex-col gap-2">
                                                        ...
                                                        <p className="font-semibold text-gray-900 text-sm">#12354–09893</p>
                                                    </div>
                                                    <div className="flex flex-col gap-2">
                                                        <div className="flex items-center gap-1 text-gray-400 text-sm">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                                        ...
                                                        <p className="font-semibold text-gray-900 text-sm">23 January 2023</p>
                                                    </div>
                                                    <div className="flex flex-col gap-2">
                                                        <div className="flex items-center gap-1 text-gray-400 text-sm">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
