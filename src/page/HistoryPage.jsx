...
export function HistoryPage() {
  ...
  if (history.length === 0) return <p className="text-xl">Belum ada transaksi.</p>;
  return (
    <>
            ...
            <div className="flex flex-col md:flex-row items-start justify-between md:items-center md:mt-0 my-10 gap-5 lg:gap-0">
              <div className="flex items-center gap-3 bg-gray-100 px-5 py-2 rounded-md text-gray-800 md:order-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 1024 1024" className="rotate-180">
                  <path fill="#000" d="m488.832 344.32l-339.84 356.672a32 32 0 0 0 0 44.16l.384.384a29.44 29.44 0 0 0 42.688 0l320-335.872l319.872 335.872a29.44 29.44 0 0 0 42.688 0l.384-.384a32 32 0 0 0 0-44.16L535.168 344.32a32 32 0 0 0-46.336 0" strokeWidth="25.5" stroke="#000" />
                </svg>
              </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-10">
                      <div className="flex flex-col gap-3 w-full">
                          ...
                          <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-1 text-gray-400 text-sm">
                              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                <g fill="none" stroke="#9CA3AF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
                        ...
                        <div className="col-span-2 lg:col-span-1 flex items-end">
                          <Link to={`/detail-order/${items.id}`} className="text-[#FF8906] text-sm font-semibold underline underline-offset-2">
                            Views Order Detail
                          </Link>
                        </div>
                      </div>
