        ...
        <div className="pt-30 p-5 gap-5 flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div className="flex flex-col items-center gap-4 border border-gray-200 rounded-md p-3 col-span-1 h-fit">
                    ...
                    <img src={user.pic || "/profle.png"} alt="profile image" />
                    <Button style={" bg-[#FF8906] items-center w-full text-sm py-3"}>
                        Upload New Photo
                    </Button>
                    <p className="text-sm text-[#4F5665]">Since {new Date(user.createdAt).toLocaleDateString()}</p>
                </div>
                <form className="flex flex-col items-center gap-5 border border-gray-200 rounded-md p-2 col-span-2">
                    <Input
                        label="Fullname"
                        name="fullname"
                        type="fullname"
