        ...
        <>
            <div className="flex justify-between items-center lg:px-10 xl:px-40">
                ...
                <div className="flex items-center gap-4 lg:gap-6">
                    ...
                    <Link to={"/profile"}>
                    <img src="https://cdn-icons-png.flaticon.com/128/847/847969.png" alt="" className="w-10"/>
                    </Link>
                    ...
                    {userLogin ? (
                        ...
                        <>
                            <Button
                                style={"hidden lg:flex px-5 py-2 bg-transparent border border-white text-white"}
                                onClick={() => navigate("/login")}
                            >
                                Sign In
                            </Button>
                            <Button
                                style={"hidden lg:flex px-5 py-2"}
