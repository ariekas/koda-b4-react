        ...
        <>
            <div className="flex justify-between items-cente lg:px-10 xl:px-40">
                <div className="flex lg:items-center lg:gap-20">
                    ...
                    <p className="hidden lg:flex text-lg text-white">Home</p>
                    <p className="hidden lg:flex text-lg text-white">Product</p>
                </div>
                <div className="flex items-center gap-4 lg:gap-6">
                    ...
                    {userLogin ? (
                        <Button style={"hidden lg:flex px-5 py-2"}>
                            Sign Out
                        </Button>
                    ) : (
                        <>
                            <Button style={"hidden lg:flex px-5 py-2 bg-transparent border border-white text-white"}>
                                Sign In
                            </Button>
                            <Button style={"hidden lg:flex px-5 py-2"}>
                                Sign Up
